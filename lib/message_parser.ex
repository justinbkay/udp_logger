defmodule AcmeUdpLogger.MessageParser do
  ...
  def handle_cast({:parse_packet, <<
    ...
    message = %{
      ...
      odometer_1708: odometer_1708 * 0.1609334,
      odometer_1939: odometer_1939 * 0.125,
      odometer_hi_rez: odometer_hi_rez * 0.005,
      batt_volt_1708: batt_volt_1708 * 0.05,
      batt_volt_1939: batt_volt_1939 * 0.05,
      sw_batt_volt_1708: sw_batt_volt_1708 * 0.05,
      sw_batt_volt_1939: sw_batt_volt_1939 * 0.05,
      engine_speed_1708: engine_speed_1708 * 0.25,
      engine_speed_1939: engine_speed_1939 * 0.125,
      wheel_based_speed: wheel_based_speed * 0.005,
      ...
      eng_oil_tmp_1708: eng_oil_tmp_1708 * .25 -32 * 5/9,
      ...
      eng_oil_lvl_1939: eng_oil_lvl_1939 * 0.40,
      eng_fuel_lvl_1_1708: eng_fuel_lvl_1_1708 * 0.50,
      eng_fuel_lvl_1_1939: eng_fuel_lvl_1_1939 * 0.40,
      eng_fuel_lvl_2_1708: eng_fuel_lvl_2_1708 * 0.50,
      eng_fuel_lvl_2_1939: eng_fuel_lvl_2_1939 * 0.40,
      seatbelt_switch: seatbelt_switch,
      eng_inst_fuel_econ_1708: eng_inst_fuel_econ_1708 * 1/256,
      eng_inst_fuel_econ_1939: eng_inst_fuel_econ_1939 * 1/512,
      eng_fuel_rate_1708: eng_fuel_rate_1708 * 1/64,
      eng_fuel_rate_1939: eng_fuel_rate_1939 * 0.05,
      hi_rez_eng_fuel_rate_1939: hi_rez_eng_fuel_rate_1939 * 0.001,
      transmission_gear_1939: transmission_gear_1939 -125,
      accel_pedal_position_1708: accel_pedal_position_1708 * 0.4,
      accel_pedal_position_1939: accel_pedal_position_1939 * 0.4,
